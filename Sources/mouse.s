...
HideMouse
.(
	; No need to check if mouse is Off, 
	; because it would not be Shown in that case
	lda MouseShown
	bne doit
ret	
	rts
...
;skip	
	...
	rts
menu	
	; Shows up the menu if not on a cutscene
	jmp DoMenu
.)
...
joybits .byt %00100, %00001, %00010, %01000, %10000	; Direct result of IJK driver
